...
class Index extends Component {
  ...
  state = {
    ...
    skuModalShow:false,
    skuData: [],
    buyType:1,//购买类型1是立即购买 2 加入购物车 3 充币购买
            ...
            <View className='gouwuBtn_box'>
                ...
                <View className="footer-cont flex">
                  ...
                  <View className="wrap-btns flex flex1">
                    ...
                    <View hidden={!isRechargeBuy} onClick={this.buyRechargeFn} className="flex1 theme-bgCz">充币购买</View>
                  </View>
                </View>
            </View>
        </View>
