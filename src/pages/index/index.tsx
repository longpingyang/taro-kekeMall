                ...
                <View className='item_box'>
                  ...
                  <View className='item_right'>
                    <View className='txtCon'>
                      ...
                      {
                        item.type==5 && <View className="font24">充币陪数：{JSON.parse(item.rule).saveTimes}</View>
                      }
                      
                      <View className='price_box'>
                        {
                          item.type==4 && <Button onClick={this.goRecharge.bind(this,item.rule)}>去充币</Button>
                        }
                        {
                          item.type==5 && <Button onClick={this.goGiveShow.bind(this,item.goodsId,item.rule)}>去充币</Button>
                        }
                      </View>
                    </View>
                  </View>
